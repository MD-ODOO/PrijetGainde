...
PROJECT_MGMT_PROFILE_TYPES = {
    ...
    "gpm_project_user_portal": "Projets - Collaborateur Portail",
...
class GaindeGlobalSyncProjectManagementUserProfiles(models.Model):
    ...
    def _gainde_project_management_apply_implied_groups(self, profile_type):
        ...
        group_map = {
            ...
            "gpm_project_user_portal": self.env.ref(
                "pk_advance_employee_portal.ad_group_timesheets", raise_if_not_found=False
            ),
    ...
    def _gainde_ensure_default_profiles(self):
        ...
        defaults = [
            ...
            ("Profil Projets - Collaborateur Portail", "gpm_project_user_portal"),
